    ...
    <div id="tracking-page">
        <div id="left-container" class="containers">
            ...
            <div id="charts-bubble" class="bubble">
                ...
                <div id="funnelchart">
                    ...
                    <h3 class="application-funnel-chart">Application Process Funnel Chart</h3>
                </div>
                <div id="piechart">
                    <img src="@/assets/images/yesyesyes.png" id="another-pie-icon" class='charts'/>
        ...
        <div id="right-container" class="containers">
            ...
            <div class="tracking-cards-container">
                <tracking-card v-for="job in jobs" 
                :key="job.id" 
                :job="job" 
