  ...
  <div class="tracking-card" @click="closeDropdown">
    ...
    <div class="job-notes-detail-trash">
      ...
      <input
        ...
        class="notes-input"
      />
      <div class="job-details" @click="editDetails">{{ job.details }}</div>
      <img
  ...
  data() {
    return {
      ...
      options: [
        ...
        { value: 'interview', label: 'Interview', colorClass: 'interview' },
        { value: 'offered', label: 'Offered', colorClass: 'offered' },
        { value: 'rejected', label: 'Rejected', colorClass: 'rejected' },
...
.applied { background-color: #526d82; color: white;}
.pending { background-color: #a4d0a4; color: black;}
.interview { background-color: #ffead2; color: black;}
.offered { background-color: #00bf63; color: black;}
.rejected { background-color: #ce243b; color: white;}
.closed { background-color: #85586f; color: white;}
...
.notes-icon:hover, .delete-icon:hover {
  opacity: 50%;
  transform: scale(1.1);
