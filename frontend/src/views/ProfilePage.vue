        ...
        >
          <div class="modal-content" @click.stop>
            ...
            <div class="input-container">
              ...
              />
              <font-awesome-icon
                :icon="['fas', showCurrentPassword ? 'eye' : 'eye-slash']"
                class="password-icon"
            ...
            <div class="input-container">
              <div class="input-field">
                ...
                />
                <font-awesome-icon
                  :icon="['fas', showNewPassword ? 'eye' : 'eye-slash']"
                  class="password-icon"
                  @click.stop="showNewPassword = !showNewPassword"
                />
              </div>
              <div class="password-hint">
                New Password must contain a mix of uppercase and lowercase
                letters, one number, one special character, and be at least 8
                characters long.
              </div>
            </div>
